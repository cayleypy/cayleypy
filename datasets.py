...
def _compute_lsl_cayley_growth(n: str) -> list[int]:
    return CayleyGraph(prepare_graph("lsl", n=int(n))).bfs().layer_sizes
...
def generate_datasets():
    ...
    _update_dataset("lsl_cayley_growth", keys, _compute_lsl_cayley_growth)
