...
class Puzzles:
    ...
    def picture_puzzle333() -> CayleyGraphDef:
        """Cayley graph for the Picture Cube puzzle -- a variant of the 333 Rubik’s Cube where each face has an oriented image.
        It is a subgroup of S_72,  generated by 18 elements, yielding a regular, undirected graph of degree 18.
