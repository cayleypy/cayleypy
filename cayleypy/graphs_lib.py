...
def prepare_graph(name: str, n: int = 0, **kwargs) -> CayleyGraphDef:
    ...
    if name == "all_transpositions":
        ...
        x = MatrixGenerator.create([[1, 1, 0], [0, 1, 0], [0, 0, 1]], modulo=n)
        x_inv = MatrixGenerator.create([[1, -1, 0], [0, 1, 0], [0, 0, 1]], modulo=n)
        y = MatrixGenerator.create([[1, 0, 0], [0, 1, 1], [0, 0, 1]], modulo=n)
        y_inv = MatrixGenerator.create([[1, 0, 0], [0, 1, -1], [0, 0, 1]], modulo=n)
