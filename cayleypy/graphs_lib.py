...
class PermutationGroups:
    ...
    def coxeter_b(n: int) -> CayleyGraphDef:
        ...
        The generators are realized as the following elements of S_{2n}:
        (0,1)(n,n+1),(1,2)(n+1,n+2),...,(n-2,n-1)(2n-2,2n-1) and (0,n)
        """
        assert n >= 2
        generator_names = []
    ...
    def coxeter_d(n: int) -> CayleyGraphDef:
        ...
        The generators are realized as the following elements of S_{2n}:
        (0,1)(n,n+1),(1,2)(n+1,n+2),...,(n-2,n-1)(2n-2,2n-1) and (0,n+1)(1,n)
        """
        assert n >= 2
        generator_names = []
        generators = np.repeat([np.arange(2 * n, dtype=np.long)], n, axis=0)
