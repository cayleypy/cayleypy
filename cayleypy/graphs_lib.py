...
=======
    def rapapport_m1(n: int) -> CayleyGraphDef:
        """Cayley graph generated by Rapapport's M1 generators (maximal subsequences of transpositions)."""
        generators = []
        generator_names = []
