...
def matrix_group(name: str, modulo: int = 0):
    """Returns pre-defined Cayley graph for matrix group.

    Supported graphs:
      * "heisenberg" - Cayley graph for group of upper triangular 3x3 integer matrices with 1s on main diagonal.
