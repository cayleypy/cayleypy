...
def prepare_graph(name: str, n: int = 0, **kwargs) -> CayleyGraphDef:
    ...
    Supported graphs:
      ...
      * "pyraminx" - Cayley graph for a subgroup pf S_36 acting on 36 tiles. It is generated by 8 elements inspired by Pyraminx puzzle.
          4 elemets represent rotations  of the tetrahedron tips, while 4 others -- rotations of its base layers. 
